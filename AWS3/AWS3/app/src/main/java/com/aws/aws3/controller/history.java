...
//        });
    ...
    private AdapterView.OnItemClickListener onItemClickListener
        ...
        new AlertDialog.Builder(history.this)
                .setTitle("again")
                .setMessage("Are you sure you want to restart the mission?")
                ...
                if (result) {
                    ...
                    try {
                        m += String.format("DATE:%s\n\n", raw.getJSONObject(0).getString("date"));
                                        ...
                                        Intent intent = new Intent(history.this, prepare_mission.class);
                                        history.this.finish();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.help_item:
                ...
                return true;
            case R.id.taskitem:
                Intent his = new Intent(history.this, prepare_mission.class);
                startActivity(his);
                return true;
